...
class SoundsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sound" do
    assert_difference('Sound.count') do
      post sounds_url, params: { sound: { file: @sound.file, name: @sound.name, picture: @sound.picture } }
    end
  ...
  test "should update sound" do
    patch sound_url(@sound), params: { sound: { file: @sound.file, name: @sound.name, picture: @sound.picture } }
